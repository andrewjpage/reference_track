...
is(ReferenceTrack::Repository::Version->new(version_number => "10")->next_version,"11",'next version for major release');
is(ReferenceTrack::Repository::Version->new(version_number => "10.0")->next_version,"11",'next version for major release');
