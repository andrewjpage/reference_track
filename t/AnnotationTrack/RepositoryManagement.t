...
BEGIN {
    ...
    use_ok('AnnotationTrack::Repository::Management');
}
...
ok my $repository_to_create  = AnnotationTrack::Repository::Management->new(environment  => 'staging'), 'initialise a repo to create';
...
ok my $repository_exists  = AnnotationTrack::Repository::Management->new(environment  => 'staging'), 'initialise a repo to create';
